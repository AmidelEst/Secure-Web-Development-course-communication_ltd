...
SECRET_KEY = 'django-insecure-vk160$#w722!7(a$m2=!1smt8e940dgk9n*-$ycim&a#)d2j0_'
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,
        'OPTIONS': {
            'autoescape': False, # ! this should be escaped to avoid XSS !
            'context_processors': [
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'amitpom14@gmail.com'
EMAIL_HOST_PASSWORD = 'ljnr jpgd nqpv lyoy'
